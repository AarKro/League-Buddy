...
export const VoiceLine: {[k: string]: VoiceLine} = {
  ...
  CHAMPION_KILL_EXECUTED_FRIENDLY_1: { path: VOICE_FILE_BASE_URL + "champion_kill_executed_friendly_1.mp3", tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED, VoiceLineTag.SAME_TEAM] },
  CHAMPION_KILL_EXECUTED_FRIENDLY_2: { path: VOICE_FILE_BASE_URL + "champion_kill_executed_friendly_2.mp3", tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED, VoiceLineTag.SAME_TEAM] },
  CHAMPION_KILL_EXECUTED_FRIENDLY_3: { path: VOICE_FILE_BASE_URL + "champion_kill_executed_friendly_3.mp3", tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED, VoiceLineTag.SAME_TEAM] },
  CHAMPION_KILL_EXECUTED_1:          { path: VOICE_FILE_BASE_URL + "champion_kill_executed_1.mp3",          tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED] },
  CHAMPION_KILL_EXECUTED_2:          { path: VOICE_FILE_BASE_URL + "champion_kill_executed_2.mp3",          tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED] },
  CHAMPION_KILL_EXECUTED_3:          { path: VOICE_FILE_BASE_URL + "champion_kill_executed_3.mp3",          tags: [EventType.CHAMPION_KILL, VoiceLineTag.EXECUTED] },
